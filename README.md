...
- 18 tools covering the full project lifecycle plus personal link management
- Guest users get 20 Dash messages (DB-enforced, cannot be bypassed)
...
- First-time guest onboarding tour (driver.js) with 6 steps including an MCP explainer
...
### 6. Enable auto-cleanup for guest data (optional)
...
Open [http://localhost:3000](http://localhost:3000). Sign in with the owner credentials you created in step 7.
...
components/
  OnboardingTour.tsx               # driver.js 6-step guest tour
```
